...
if __name__ == '__main__':
    ...
    parser.add_argument('--action', default="list", help='Available actions are "list", "download". Defailt action is list')
    ...
    for word in args.keywords:
        if args.action == 'list':
            for book_title in filtered_books['title']:
                print(book_title)
            ...
            for book_url in filtered_books['url']:
                ...
                if page.status_code == 200:
                    ...
                    filename = str(random.randint(1,1000000)) + '_'.join([word.strip() for word in soup.title.string.split()[0:-2]]) + '.pdf'
                    print(filename)
